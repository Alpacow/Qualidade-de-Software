...
public class TestWebsite {
    ...
    // testa se o butão submit da busca existe -> component 3: <input>
    @Test
    ...
    //se colocar um espa�o j� da erro
    @Test
    ...
    public void testaBotaoVerify(){
        ...
        if (element.isDisplayed()) {
            System.out.println("Botão de verificação está na página.");
        }
        else {
            System.out.println("Botão de verificação não encontrado!!!");
        }
    }
    */
}
